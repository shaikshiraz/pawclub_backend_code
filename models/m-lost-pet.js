...
const lost=mongoose.model('lost-pet',new mongoose.Schema(
    {        
      name:{
        type:String,
        //   required:true,
...
// age17:Joi.string(),
       ...
       return Joi.validate(lost,schema);
   }


   module.exports.lost=lost;
   module.exports.validate=validateLost;